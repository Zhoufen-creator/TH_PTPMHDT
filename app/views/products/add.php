    ...
    <div class="tech-card">
        <form id="addProductForm" enctype="multipart/form-data"> 
            ...
            <div class="form-group mb-4"> 
                ...
                <input type="text" id="name" name="name" class="form-control tech-input" required> 
            </div> 
            
            <div class="form-group mb-4"> 
                <label for="description" class="tech-label">Mô tả chi tiết:</label> 
                <textarea id="description" name="description" class="form-control tech-input" rows="4" required></textarea> 
            </div> 
            
            <div class="row">
                <div class="form-group mb-4 col-md-6"> 
                    <label for="price" class="tech-label">Giá (USD):</label> 
                    <input type="number" id="price" name="price" class="form-control tech-input" step="0.01" required> 
                </div> 
                
                <div class="form-group mb-4 col-md-6"> 
                    <label for="category_id" class="tech-label">Danh mục hệ thống:</label> 
                    <select id="category_id" name="category_id" class="form-select tech-input" required> 
                        <?php foreach ($categories as $category): ?> 
                            <option value="<?php echo $category->id; ?>" style="background: #1e1e26; color: #fff;">
            ...
            <div class="form-group mb-5"> 
                <label for="image" class="tech-label">Đính kèm hình ảnh:</label> 
                <input type="file" id="image" name="image" class="form-control tech-input" accept="image/*"> 
            </div> 
